...
def main():
    ...
    """
    videos = 'data/josh_videos.txt'  # txt containing all of the video IDs
    file_name = 'data/josh.csv'  # output file name here (will overwrite an existing file with the same name)
